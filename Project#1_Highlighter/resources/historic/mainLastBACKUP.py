...
acad.Visible = True
doc = acad.Documents.Open(os.path.join(os.path.abspath(os.path.dirname(__file__)), "input", "6E162.dwg"))
time.sleep(10)          #Give time to fetch and open

modSpace = acad.ActiveDocument.ModelSpace
